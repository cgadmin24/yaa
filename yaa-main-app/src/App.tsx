  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#dbe7ff]/80 bg-white/90 backdrop-blur-xl">
      <div className="mx-auto flex h-[86px] max-w-[1320px] items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <a
          className="hidden rounded-[8px] bg-[#0b57e3] px-5 py-3 text-[14px] font-bold text-white shadow-[0_14px_32px_rgba(11,87,227,0.26)] transition hover:bg-[#0848be] sm:inline-flex xl:hidden"
          href={contactHref}
        >
          Talk To Us
        </a>
...
function HeroVisual() {
  return (
    <div className="relative mx-auto w-full max-w-[560px] lg:mr-0">
      <div className="absolute -left-10 top-12 hidden h-44 w-28 rounded-r-full bg-[#90ead7] lg:block" />
      <div className="absolute -right-8 top-4 h-20 w-20 rotate-12 rounded-[18px] border-2 border-[#ad6bff] opacity-70" />
      <div className="absolute left-6 top-2 grid grid-cols-3 gap-2 text-[#ff786f]">
      ...
      <div className="absolute -left-4 bottom-8 rounded-[16px] bg-white p-5 shadow-[0_24px_60px_rgba(8,38,92,0.16)] sm:left-8">
        <div className="mb-3 grid h-12 w-12 place-items-center rounded-full bg-[#12c879] text-white">
          <Users className="h-6 w-6" />
        </div>
        <p className="text-[13px] font-semibold text-[#45618c]">Learners coached</p>
        <p className="font-display text-[32px] font-extrabold text-[#08265c]">18K+</p>
      </div>
      ...
      <div className="absolute -right-2 top-1/2 rounded-[16px] bg-white p-5 shadow-[0_24px_60px_rgba(8,38,92,0.16)]">
        ...
        <p className="text-[13px] font-semibold text-[#45618c]">Confidence reps</p>
        <p className="font-display text-[32px] font-extrabold text-[#08265c]">34K</p>
      </div>
    </div>
  );
}
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(120deg,#f7fbff_0%,#f4f8ff_54%,#fff7fb_100%)]">
        <div className="mx-auto grid min-h-[670px] max-w-[1320px] items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8 lg:py-20">
          ...
          >
            ...
            <h1 className="max-w-[690px] font-display text-[46px] font-extrabold leading-[1.08] tracking-tight text-[#08265c] sm:text-[60px] lg:text-[68px]">
              Skills get you shortlisted.{" "}
              <span className="text-[#0b57e3]">Delivery</span> gets you hired.
            </h1>
            <p className="mt-6 max-w-[600px] text-[17px] font-medium leading-8 text-[#365783]">
      ...
      <section className="border-y border-[#dbe7ff] bg-white">
        <div className="mx-auto grid max-w-[1320px] gap-4 px-4 py-8 sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:px-8">
          {categories.map((category) => (
            <a
              className="group flex items-center justify-between rounded-[10px] border border-[#dbe7ff] bg-white px-5 py-4 shadow-sm transition hover:-translate-y-1 hover:border-[#0b57e3] hover:shadow-[0_18px_44px_rgba(8,38,92,0.08)]"
              href={category === "Interview Prep" ? "/hirable2" : "/courses"}
              key={category}
            >
              <span className="font-bold text-[#08265c]">{category}</span>
              <ArrowRight className="h-4 w-4 text-[#0b57e3] transition group-hover:translate-x-1" />
            </a>
          ))}
        </div>
      </section>
      ...
      <div className="mx-auto grid max-w-[1320px] items-center gap-14 px-4 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
        <div className="relative">
          ...
          <div className="absolute -bottom-7 right-8 rounded-[16px] bg-white px-6 py-5 shadow-[0_24px_60px_rgba(8,38,92,0.14)]">
            <p className="font-display text-[34px] font-extrabold text-[#0b57e3]">3x</p>
            <p className="text-[13px] font-bold text-[#45618c]">More real practice</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            {[
              ...
              <div className="rounded-[12px] border border-[#dbe7ff] bg-[#f8fbff] p-5" key={label}>
                <p className="font-display text-[30px] font-extrabold text-[#08265c]">{value}</p>
                <p className="mt-1 text-[14px] font-bold text-[#6b83aa]">{label}</p>
              </div>
            ))}
          </div>
        </div>
    ...
    <section className="bg-[#f5f9ff] py-20">
      <div className="mx-auto max-w-[1320px] px-4 sm:px-6 lg:px-8">
        <div className="mb-10 flex flex-col justify-between gap-5 md:flex-row md:items-end">
          ...
          <a
            className="inline-flex items-center gap-2 text-[15px] font-extrabold text-[#0b57e3]"
            href="/courses"
          >
            View all courses
            <ArrowRight className="h-4 w-4" />
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {programs.map((program) => (
            <a
              className="group rounded-[14px] border border-[#dbe7ff] bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(8,38,92,0.1)]"
              href={program.href}
              key={program.title}
            >
              <div className="mb-5 flex items-center justify-between">
                <span className="rounded-[6px] bg-[#e9f1ff] px-3 py-1.5 text-[12px] font-extrabold text-[#0b57e3]">
                  {program.category}
                </span>
                <span className="flex items-center gap-1 text-[#f4b000]">
                  <Star className="h-4 w-4 fill-current" />
                  <span className="text-[13px] font-bold text-[#45618c]">4.9</span>
                </span>
              </div>
              <h3 className="font-display text-[25px] font-extrabold text-[#08265c]">
                {program.title}
              </h3>
              <p className="mt-3 min-h-[78px] text-[15px] font-medium leading-7 text-[#45618c]">
                {program.description}
              </p>
              <div className="mt-5 flex items-center justify-between border-t border-[#dbe7ff] pt-5">
                <span className="text-[13px] font-bold text-[#6b83aa]">{program.lessons}</span>
                <span className="font-display text-[18px] font-extrabold text-[#0b57e3]">
                  {program.price}
                </span>
              </div>
            </a>
    ...
    >
      <div className="grid gap-6 lg:grid-cols-3">
        {[
          ...
          <div className="rounded-[14px] border border-[#dbe7ff] bg-white p-7" key={title}>
            <CheckCircle2 className="mb-5 h-8 w-8 text-[#12c879]" />
            <h3 className="font-display text-[24px] font-extrabold text-[#08265c]">{title}</h3>
            <p className="mt-3 text-[15px] font-medium leading-7 text-[#45618c]">{text}</p>
          </div>
        ))}
      </div>
    </PageShell>
  ...
  return (
    ...
    >
      <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="rounded-[16px] bg-[#0b57e3] p-8 text-white">
          ...
          <a
            className="mt-8 inline-flex items-center gap-2 rounded-[8px] bg-white px-6 py-4 text-[15px] font-extrabold text-[#0b57e3]"
            href={contactHref}
          >
            Send email
            <ArrowRight className="h-4 w-4" />
        ...
        <div className="rounded-[16px] border border-[#dbe7ff] bg-white p-8">
          <div className="grid gap-4">
            {["Name", "Email", "What do you want to build next?"].map((label) => (
              <label className="grid gap-2" key={label}>
                <span className="text-[13px] font-extrabold text-[#45618c]">{label}</span>
                <span className="rounded-[8px] border border-[#dbe7ff] bg-[#f8fbff] px-4 py-4 text-[#8aa0bf]">
                  {label}
                </span>
              </label>
            ))}
    ...
    <main className="bg-[#f5f9ff]">
      <section className="mx-auto max-w-[1320px] px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div className="mb-12 max-w-[800px]">
          ...
          <h1 className="font-display text-[42px] font-extrabold leading-tight text-[#08265c] sm:text-[56px]">
            {title}
          </h1>
          <p className="mt-5 text-[17px] font-medium leading-8 text-[#45618c]">
            {description}
          </p>
        </div>
        {children}
